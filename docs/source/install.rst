...
Download the `deb <https://github.com/jethornton/mesact/raw/master/mesact_0.0.1_amd64.deb>`_

Or use wget from a terminal
::

	wget https://github.com/jethornton/mesact/raw/master/mesact_0.0.1_amd64.deb
