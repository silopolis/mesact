...
Download the `deb <https://github.com/jethornton/mesact/raw/master/mesact_0.4.3_amd64.deb>`_

Or use wget from a terminal
::

	wget https://github.com/jethornton/mesact/raw/master/mesact_0.4.3_amd64.deb
