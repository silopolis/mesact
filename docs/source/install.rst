...
Download the `deb <https://github.com/jethornton/mesact/raw/master/mesact_0.3.0_amd64.deb>`_

Or use wget from a terminal
::

	wget https://github.com/jethornton/mesact/raw/master/mesact_0.3.0_amd64.deb
